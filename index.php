...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Chai near You</span></h2>
      <p>Chai, Which Is Often Pronounced “Chee-Ah,"</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Chai 2 Chai </a></li>
        </ul>
      </div>
      <!-- Recently Listed Chai  -->
